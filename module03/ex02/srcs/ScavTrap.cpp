...
/*   Updated: 2022/10/19 10:43:18 by vrigaudy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(void) : ClapTrap() {
	...
	std::cout << std::endl << "ScavTrap " << _name << " awakens!" << std::endl;
}
...
ScavTrap::~ScavTrap(void) {
	std::cout << std::endl << "ScavTrap " << _name << " goes back to sleep." << std::endl;
}
